    ...
    return Scaffold(
      ...
      body: Center(
        child: Padding(
          ...
          child: ListView(
            children: [
              Column(children: [SliderImage()]),
              AppWidgets.gap,
              headlines(
                title: AppTexts.discover,
                context: context,
                navigate: context.watch<GameController>().allGames,
              ),
              AppWidgets.gap,
              Discover(),
              AppWidgets.gap,
              headlines(
                title: AppTexts.upcoming,
                context: context,
                navigate: context.watch<GameController>().upComingGames,
              ),
              AppWidgets.gap,
              Upcoming(),
              AppWidgets.gap,
              headlines(
                title: AppTexts.newgame,
                context: context,
                navigate: context.watch<GameController>().newGames,
              ),
              AppWidgets.gap,
              NewRelease(),
            ],
